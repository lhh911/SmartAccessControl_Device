...
import com.hyphenate.easeui.PhoneStateManager;
...
//                                        callStateTextView.setText(s6);
    ...
    public void onClick(View v) {
        ...
        if (v.getId() == R.id.local_surface) {
            changeCallView();
        } else if (v.getId() == R.id.btn_refuse_call) { // decline the call
            isRefused = true;
            refuseBtn.setEnabled(false);
            handler.sendEmptyMessage(MSG_CALL_REJECT);
        } else if (v.getId() == R.id.btn_answer_call) { // answer the call
        ...
        } else if (v.getId() == R.id.btn_hangup_call) {// hangup
        ...
        } else if (v.getId() == R.id.iv_mute) { // mute
            if (isMuteState) {
        ...
        } else if (v.getId() == R.id.iv_handsfree) { // handsfree
            if (isHandsfreeState) {
                // turn off speaker
...
//                callHelper.startVideoRecord(PathUtil.getInstance().getVideoPath().getAbsolutePath());
        ...
        */
        ...
        } else if (v.getId() == R.id.btn_switch_camera) { //switch camera

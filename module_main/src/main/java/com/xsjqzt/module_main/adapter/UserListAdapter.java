...
import com.xsjqzt.module_main.util.GlideUtil;
...
//            }
//        });
        userListViewHolder.bt_delete.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                if (null != mOnItemClickListener) {
                    mOnItemClickListener.onClick(position);
    ...
    static class UserListViewHolder extends RecyclerView.ViewHolder {
        ...
        private UserListViewHolder(View view) {
            super(view);
            cv_list_item = view.findViewById(R.id.cv_list_item);

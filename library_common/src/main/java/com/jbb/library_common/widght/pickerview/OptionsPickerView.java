package com.jbb.library_common.widght.pickerview;
...
import com.jbb.library_common.widght.pickerview.view.BasePickerView;
import com.jbb.library_common.widght.pickerview.view.WheelOptions;
...
public class OptionsPickerView<T> extends BasePickerView implements View.OnClickListener {
    ...
    public void onClick(View v)
    {
        ...
        else
        {
            if(optionsSelectListener!=null)
            {
                ...
                if(optionsCurrentItems.length > 0)
    ...
    public interface OnOptionsSelectListener {
        void onOptionsSelect(int options1Index, int options2Index, int options3Index);
    }
